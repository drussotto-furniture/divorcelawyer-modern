...
export default function CityEditForm({ city }: CityEditFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(isNew ? 'City created successfully!' : 'City updated successfully!')
      if (isNew && result.data) {
        router.push(`/admin/directory/locations/cities/${result.data.id}`)
      } else {
        router.refresh()
      }
    } catch (err) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (!formData.slug || formData.slug === city?.slug) {
                setFormData(prev => ({
                  ...prev,
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setFormData({ ...formData, state_id: e.target.value, county_id: '' })}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
            disabled={loadingCounties || !formData.state_id}
          >
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
            placeholder="City description or content..."
          />
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
            placeholder="Los Angeles Divorce Lawyers | [Site Name]"
          />
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
            placeholder="Find experienced divorce lawyers in Los Angeles..."
          />
        </div>
      </div>
      ...
      <div className="flex justify-end gap-4">
        ...
        >
          {loading ? 'Saving...' : isNew ? 'Create City' : 'Save Changes'}
        </button>
      </div>
    </form>
  )
