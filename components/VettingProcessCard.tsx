...
export default function VettingProcessCard({ bgCondition, textCondition }: VettingProcessCardProps) {
  return (
    <div className="flex-1 min-w-[280px] sm:min-w-[320px] lg:min-w-0 max-w-[450px] lg:max-w-none w-full lawyer-card-pack flex flex-col lg:h-full law-firmscard vetting-process bg-white rounded-lg p-6 lg:p-8 shadow-sm">
      <div className="flex flex-col h-full">
        ...
        <ul className="space-y-3 lg:space-y-4 flex-1 list-disc pl-6 lg:pl-8">
          <li className="text-bluish font-proxima text-sm lg:text-base">
