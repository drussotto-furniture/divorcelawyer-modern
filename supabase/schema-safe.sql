...
CREATE INDEX IF NOT EXISTS idx_lawyers_name ON lawyers(first_name, last_name);
...
CREATE INDEX IF NOT EXISTS idx_lawyer_service_areas_city_id ON lawyer_service_areas(city_id);
...
CREATE INDEX IF NOT EXISTS idx_contact_submissions_lawyer_id ON contact_submissions(lawyer_id);
...
CREATE INDEX IF NOT EXISTS idx_lawyers_search ON lawyers USING GIN(search_vector);
CREATE INDEX IF NOT EXISTS idx_law_firms_search ON law_firms USING GIN(search_vector);
CREATE INDEX IF NOT EXISTS idx_cities_search ON cities USING GIN(search_vector);
